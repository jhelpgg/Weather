package fr.jhelp.weatherservice.provider
...
/**
 * Indicates if an instance is provided for a Class
 *
 * ```kotlin
 * private val contextProvided by provided<Context>()
 *
 * // ...
 *
 * if(isProvided<Context>()) {
 *   // Can use the field contextProvided
 * }
 * ```
 */
